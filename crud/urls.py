...
from .views import signup, user_login, classroom, user_logout, add_classroom, update_classroom, \
    delete_classroom, crud_student, add_student, user_profile, update_profile, form_classroom
